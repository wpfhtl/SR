...
import models.modules.architecture as arch#in the architecture file, definie all of the model
import models.modules.sft_arch as sft_arch

####################
# initialize
####################
#this .py is more likely as a solver, the structure is in the architecture
...
def define_D(opt):
    ...
    if which_model == 'discriminator_vgg_128':####chose this in the SRGAN
